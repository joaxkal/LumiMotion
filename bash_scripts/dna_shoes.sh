...
SOURCE_PATHS=(
"data/dna/802_05_shoes/main/0802_05.smc"
)

    for SOURCE_PATH in "${SOURCE_PATHS[@]}"; do


        OUTPUT_PATH="output_dna_shoes_v2_r${RESOLUTION}"

        ### FOR THIS SCENE WE USE TIMESTEPS 10-60
        ...
        python -m scripts.train_stage1 --source_path=$SOURCE_PATH --model_path=$OUTPUT_PATH  \
            ...
            --min_opacity 0.05 --start_normal_reg 6000 --lambda_dist 0 --is_blender --start_frame 10 --end_frame 60
        ...
        python -m scripts.render_stage1_insights --source_path=$SOURCE_PATH --model_path=$OUTPUT_PATH  \
            ...
            --depth_ratio 0.0 --load_test_set_only --white_background --is_blender --start_frame 10 --end_frame 60
        ...
        python -m scripts.train_stage2 --source_path=$SOURCE_PATH --model_path=$OUTPUT_PATH  \
            ...
            --roughness_lr 0.001 --opacity_lr 0.1 --white_background --is_blender --start_frame 10 --end_frame 60
        ...
        python -m scripts.render_materials --source_path=$SOURCE_PATH --model_path=$OUTPUT_PATH  \
            ...
            --load_test_set_only --white_background --is_blender --start_frame 10 --end_frame 60
        ...
        python -m scripts.render_relight_with_hdr --source_path=$SOURCE_PATH --model_path=$OUTPUT_PATH  \
            ...
            --white_background --is_blender --start_frame 10 --end_frame 60 \
