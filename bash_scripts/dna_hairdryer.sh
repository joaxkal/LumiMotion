...
SOURCE_PATHS=(
"data/dna/0307_07_hairdryer/main/0307_07.smc"
)

    for SOURCE_PATH in "${SOURCE_PATHS[@]}"; do


        OUTPUT_PATH="output_dna_hairdryer_r${RESOLUTION}"

        ### FOR THIS SCENE WE USE TIMESTEPS 40-140
        ...
        python -m scripts.train_stage1 --source_path=$SOURCE_PATH --model_path=$OUTPUT_PATH  \
            ...
            --lambda_separation 0.005 --binarization_warm_up 100 --d_color_reg_loss_weight 0.01 \
            --densify_until_iter 20000 --densification_interval 100 --depth_ratio 1.0 --warm_up 100 \
            --min_opacity 0.05 --start_normal_reg 6000 --lambda_dist 0 --is_blender --start_frame 40 --end_frame 140
        ...
        python -m scripts.render_stage1_insights --source_path=$SOURCE_PATH --model_path=$OUTPUT_PATH  \
           --eval --resolution=$RESOLUTION --load_iter 35000 \
            --depth_ratio 0.0 --load_test_set_only --white_background \
            --is_blender --start_frame 40 --end_frame 140
        ...
        python -m scripts.train_stage2 --source_path=$SOURCE_PATH --model_path=$OUTPUT_PATH  \
            ...
            --roughness_lr 0.001 --opacity_lr 0.1 --white_background --is_blender --start_frame 40 --end_frame 140
        ...
        python -m scripts.render_materials --source_path=$SOURCE_PATH --model_path=$OUTPUT_PATH  \
            ...
            --load_test_set_only --white_background --is_blender --start_frame 40 --end_frame 140
        ...
        python -m scripts.render_relight_with_hdr --source_path=$SOURCE_PATH --model_path=$OUTPUT_PATH  \
            ...
            --white_background --is_blender --start_frame 40 --end_frame 140 \
