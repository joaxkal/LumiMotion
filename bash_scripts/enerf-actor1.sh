...
SOURCE_PATHS=(
"data/enerf_actors_1_3/actor1_710_780"
)

    for SOURCE_PATH in "${SOURCE_PATHS[@]}"; do


        OUTPUT_PATH="output_enerf_actor1_r${RESOLUTION}"
        ...
        python -m scripts.train_stage1 --source_path=$SOURCE_PATH --model_path=$OUTPUT_PATH  \
            ...
            --lambda_separation 0.0 --d_color_reg_loss_weight 0.001 --densify_until_iter 18000 --densification_interval 200 \
            --depth_ratio 0.0 --warm_up 100 --binarization_warm_up 100 --lambda_alpha_loss 0.005 \
